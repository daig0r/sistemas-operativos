...
public class Process implements Cloneable {
	...
	public int getWaitTimeHead() {
		return waitTimeHead;
	}

	public void setWaitTimeHead(int waitTimeHead) {
		this.waitTimeHead = waitTimeHead;
	}

	public Object[] tableResume() {
		return new Object[] { id, arrivalTimeHead, burstTime, startTime, finalTime, returnTime, waitTime };
	}

	public Object[] resume() {
		return new Object[] { id, arrivalTime, burstTime, startTime, finalTime, returnTime, waitTime };
	}
